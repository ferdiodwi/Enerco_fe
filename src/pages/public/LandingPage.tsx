    ...
    <div className="min-h-screen bg-slate-950 text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 bg-slate-950/70 backdrop-blur-xl border-b border-slate-800/50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link to="/login" className="text-sm text-slate-300 hover:text-white transition px-4 py-2">
              Masuk
            </Link>
            <Link
              to="/register"
              className="text-sm font-medium bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-white px-5 py-2.5 rounded-xl transition-all shadow-lg shadow-emerald-500/20"
            >
              Daftar Gratis
            </Link>
          </div>
      ...
      <section className="relative pt-32 pb-20 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            <Link
              to="/register"
              className="group flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-white font-semibold px-8 py-4 rounded-2xl text-lg transition-all shadow-xl shadow-emerald-500/25"
            >
              Mulai Sekarang <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </Link>
            <a href="#features" className="text-slate-400 hover:text-white font-medium px-8 py-4 rounded-2xl border border-slate-700 hover:border-slate-500 transition-all">
      ...
      <section className="py-16 px-6 border-y border-slate-800/50">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((s, i) => (
            <motion.div
              key={s.label} initial="hidden" whileInView="visible" viewport={{ once: true }}
      ...
      <section id="features" className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {features.map((f, i) => (
              <motion.div
                key={f.title} initial="hidden" whileInView="visible" viewport={{ once: true }}
                variants={fadeUp} transition={{ delay: i * 0.1, duration: 0.5 }}
                className="group p-8 rounded-2xl bg-slate-900/50 border border-slate-800/50 hover:border-emerald-500/30 transition-all duration-300"
              >
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500/20 to-teal-500/20 flex items-center justify-center text-emerald-400 mb-5 group-hover:scale-110 transition-transform">
                  {f.icon}
                </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-4xl font-bold mb-6">
              Bergabung dalam Transformasi{" "}
              <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">Energi Bersih</span>
            </h2>
            <p className="text-lg text-slate-400 mb-10 max-w-2xl mx-auto">
              Dukung SDG 7, SDG 9, dan SDG 17. Jadilah bagian dari ekosistem energi bersih yang adil dan berdampak.
            </p>
            <Link
              to="/register"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-white font-semibold px-8 py-4 rounded-2xl text-lg shadow-xl shadow-emerald-500/25 transition-all"
            >
      ...
      <footer className="border-t border-slate-800/50 py-12 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold">EnergEco GlobalChain</span>
          </div>
